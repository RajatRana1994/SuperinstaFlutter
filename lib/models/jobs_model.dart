...
*/
  ...
  JobsModelDataPagination({
    this.currentPage,
    this.totalPage,
    this.totalRecord,
    this.limit,
  });
  JobsModelDataPagination.fromJson(Map<String, dynamic> json) {
...
class JobsModelDataDataCategories {
/*
{
  "id": 1,
  "name": "Builders",
...
*/
  ...
  JobsModelDataDataCategories.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toInt();
...
*/
  ...
  JobsModelDataDataUsers.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toInt();
    name = json['name']?.toString();
...
*/
  ...
  int? modified;
  int? totalProposals;
  JobsModelDataDataUsers? users;
  JobsModelDataDataCategories? categories;
  ...
  JobsModelDataData.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toInt();
    ...
    users = (json['users'] != null) ? JobsModelDataDataUsers.fromJson(json['users']) : null;
    categories = (json['categories'] != null) ? JobsModelDataDataCategories.fromJson(json['categories']) : null;
  }
  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
    data['id'] = id;
...
*/
  ...
  List<JobsModelDataData?>? data;
  JobsModelDataPagination? pagination;

  JobsModelData({
    this.data,
    this.pagination,
  });
  JobsModelData.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      final v = json['data'];
      final arr0 = <JobsModelDataData>[];
      v.forEach((v) {
        arr0.add(JobsModelDataData.fromJson(v));
      });
      this.data = arr0;
    }
    pagination = (json['pagination'] != null) ? JobsModelDataPagination.fromJson(json['pagination']) : null;
  }
  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
    if (this.data != null) {
...
*/
  ...
  JobsModel.fromJson(Map<String, dynamic> json) {
    ...
    status = json['status']?.toInt();
    data = (json['data'] != null) ? JobsModelData.fromJson(json['data']) : null;
  }
  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
